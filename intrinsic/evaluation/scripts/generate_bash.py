    ...
    with open(bash_file, 'w', encoding='utf-8') as f:
        ...
        for feature in feat_dict.keys():
            for lang in feat_dict[feature]:
                ...
                f.write(
                    'allennlp train ' + scripts_dir + json_file + ' -s models/' + lang + '/' + emb_type + '/' + feature + ' --include-package classifiers\n')
    ...
    with open(bash_file, 'w', encoding='utf-8') as f:
        ...
        for feature in feat_dict.keys():
            for lang in feat_dict[feature]:
                ...
                f.write(
                    'allennlp evaluate models/' + lang + '/' + emb_type + '/' + feature + '/model.tar.gz --include-package classifiers ../../dataset_compilation/final_tests/' + feature + '/' + lang + '/test.txt --output-file ' + output_file + '\n')
            f.write('\n')
